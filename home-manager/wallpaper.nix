  ...
  src = pkgs.writeTextFile {
    ...
    text = ''
      ...
      <path
         ...
         fill="#${scheme.palette.base0D}" style="isolation:auto;mix-blend-mode:normal"/>
      <text
         xml:space="preserve"
      ...
      <text
         ...
         ><tspan
           sodipodi:role="line"
           id="tspan367-7-3"
           style="font-style:normal;font-variant:normal;fill:#${scheme.palette.base0D};font-weight:normal;font-stretch:normal;font-family:Inter;-inkscape-font-specification:Inter;stroke-width:7.19314"
           x="-530.67476"
